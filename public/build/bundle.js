...
var app = (function () {
    ...
    // (228:5) {#each row.row as cell}
    function create_each_block_2(ctx) {
    	let td;
    	let if_block = /*cell*/ ctx[12] && create_if_block$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(td, file$1, 228, 6, 4004);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(228:5) {#each row.row as cell}",
    		ctx
    	});
    ...
    // (226:3) {#each map as row}
    function create_each_block_1(ctx) {
    	let tr;
    	let t;
    	let each_value_2 = /*row*/ ctx[9].row;
    	let each_blocks = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tr, file$1, 226, 4, 3964);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(242:2) {#each orders as order}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(link, file$1, 218, 1, 3773);
    			attr_dev(table, "class", "svelte-11ervpo");
    			add_location(table, file$1, 224, 2, 3930);
    			attr_dev(div0, "class", "map svelte-11ervpo");
    			add_location(div0, file$1, 223, 1, 3910);
    			attr_dev(h1, "class", "svelte-11ervpo");
    			add_location(h1, file$1, 240, 2, 4211);
    			attr_dev(div1, "class", "orders svelte-11ervpo");
    			add_location(div1, file$1, 239, 1, 4188);
    			attr_dev(div2, "class", "content svelte-11ervpo");
    			add_location(div2, file$1, 222, 0, 3887);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function handleKeydown(event) {
    		...
    		if (validKey(key)) {
    			console.log(key);
    			let keyPress = messages_6.create({ keyPress: key });
    			console.log(keyPress);
    			let bytes = messages_6.encode(keyPress).finish();
    			console.log(bytes);
