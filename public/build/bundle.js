...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	let t_value = /*cell*/ ctx[7].slice(1) + "";
    	let t;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*map*/ 1 && t_value !== (t_value = /*cell*/ ctx[7].slice(1) + "")) set_data_dev(t, t_value);
    		},
    ...
    // (132:3) {#each row.row as cell}
    function create_each_block_1(ctx) {
    	let td;
    	let if_block = /*cell*/ ctx[7] && create_if_block(ctx);

    	const block = {
    		c: function create() {
    			td = element("td");
    			if (if_block) if_block.c();
    			set_style(td, "background-color", cellToColor(/*cell*/ ctx[7].charAt(0)));
    			attr_dev(td, "class", "svelte-18ahk4x");
    			add_location(td, file, 132, 4, 3525);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(132:3) {#each row.row as cell}",
    		ctx
    	});
    ...
    // (130:1) {#each map as row}
    function create_each_block(ctx) {
    	let tr;
    	let t;
    	let each_value_1 = /*row*/ ctx[4].row;
    	let each_blocks = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tr, file, 130, 2, 3489);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(table, file, 128, 0, 3459);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function handleKeydown(event) {
    		...
    		if (validKey(key)) {
    			console.log(key);
    			let keyPress = messages_6.create({ key_press: key });
